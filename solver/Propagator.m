function [X2,Y2,seized]=Propagator(max_lon,min_lon,max_lat,min_lat,LON,LAT,U,V,T,Tstep,X1,Y1,seized,nx,ny,forward,method)


if method==1       
    [X2,Y2]=Propagate_Euler(LON,LAT,U,V,X1,Y1,Tstep,forward);
else
    [X2,Y2]=Propagate_RK4(LON,LAT,U,V,X1,Y1,Tstep,forward);
end
