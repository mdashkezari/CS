...
function [GridX2,GridY2]=Propagate_RK4(LON,LAT,U,V,GridX1,GridY1,Tstep_sec,forward)
...
GridX2=GridX1+dir*Tstep_sec*((iu1+2*iu2+2*iu3+iu4)/6)./dx;
GridY2=GridY1+dir*Tstep_sec*((iv1+2*iv2+2*iv3+iv4)/6)./dy;
