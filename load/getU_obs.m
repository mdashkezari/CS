...
function [U] = getU_obs(DataSource,itnum)

  if strcmp(DataSource,'AVISO')
    [lon lat U]=getU_AVISO(DataSource,itnum);
...
function [lon lat U] = getU_AVISO(DataSource,itnum)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  AVISO  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%[lon lat U]=get_obs(DataSource,2,itnum);       % absolute
[lon lat U]=get_obs(DataSource,1,itnum);       % anomally
U=U/10000;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end
